...
- [x] lib/resilience/retry-strategy.ts
- [x] lib/queue/phase1-worker.ts (modified)
- [x] app/api/marketplace/diagnostics/route.ts (modified)
- [x] __tests__/resilience/retry-strategy.test.ts
- [x] __tests__/queue/phase1-worker.retry.test.ts
