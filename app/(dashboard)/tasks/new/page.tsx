...
export default function NewTaskPage() {
  ...
  // PERMANENTLY REMOVED: No permission checks - all authenticated users can create tasks
  // Role-based restrictions will be re-implemented after proper role sync in database
